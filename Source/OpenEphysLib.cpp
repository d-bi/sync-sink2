...
#include "SyncSink.h" // update to point to your custom header file
...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "SyncSink2"; // Name of the plugin library
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "SyncSink2"; // Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<SyncSink>);
		break;
